function Gradient(WIDTH, HEIGHT){
    ...
    this.update = function(){
        ...
        this.gradient.addColorStop(0.5, this.colors[1]);
    ...
    this.sampleColors = function(){
        // this.hue = Math.random()*360;
        // this.hue2 = this.hue + 100;
        this.colors[0] = hslaColor(Math.random()*360, Math.random()*100, 0, this.alpha)
        this.colors[1] = hslaColor(Math.random()*360, Math.random()*100, 100, this.alpha)
