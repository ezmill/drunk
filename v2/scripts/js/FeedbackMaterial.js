function FeedbackMaterial(RENDERER, SCENE, CAMERA, TEXTURE, SHADERS) {
    ...
    this.init = function() {
        ...
        // this.material.uniforms.texture.value = THREE.ImageUtils.loadTexture(PATH + "textures/IMG_6559.jpg");
        ...
        this.geometry = new THREE.PlaneGeometry(renderSize.x*1.2, renderSize.y*1.2, 0);
